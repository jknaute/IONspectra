...
function nice_ticks()
    ...
    ax[:set_position](mpltrafo.Bbox([[0.12, 0.14], [0.96, 0.96]]))
end

linew = 2
rc("font", size = 27) #fontsize of axis labels (numbers)
rc("axes", labelsize = 35, lw = linew) #fontsize of axis labels (symbols)
